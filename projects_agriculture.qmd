...
::: column-margin
![The [Prairie Precision Sustainability Network](https://prairiepsn.ca/){target="_blank"} collaborates with farmers to map marginal areas in crop fields across three prairie provinces. This prototype map illustrates the kinds of decision-support tools we are designing to help farmers make their fields messier.](images/ppsn_infographic.png){#fig-ppsn}
:::

We've been working hard with our [PPSN](https://prairiepsn.ca){target="_blank"} research network colleagues (@fig-ppsn) to bring together precision yield, satellite imagery, and economic data to identify parts of fields that have multi-annual net-negative profitability. Thanks to data from over 70 farmers in Alberta, Saskatchewan and Manitoba, we've built a tool that farmers can use to help them visualize the marginally-profitable parts of their fields.
