...
::: {.responsive-small}
#### A list of our [current lab members](#current-lab) and [alumni](#alumni) can be found at the bottom of the page. {style="text-transform: none;"}
...
## Initialize first name of anyone who worked for us who was not a postdoc or a graduate student, or who is not
...
peopleD <- read_csv("D:\\OneDrive - University of Calgary\\Research\\Web\\abc-lab\\peopleLookup.csv",
...
cat("## Current lab members {#current-lab}\n")
...
cat("## Alumni {#alumni}\n")
cat("[If your name is missing, we really want to add it. Please tell [Paul](@pgalpern.qmd)!]{style=\"font-size: 0.8em;\"}\n\n")
peopleD %>% 
  filter(Alumni == "Y") %>% 
  pull(rmarkText) %>% 
  reduce(paste0) %>% 
